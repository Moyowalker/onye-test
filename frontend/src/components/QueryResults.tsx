...
export default function QueryResults({ query, nlpAnalysis, fhirResponse }: QueryResultsProps) {
  ...
  const renderPatient = (patient: Patient) => (
    <div className="p-5 bg-white border-l-4 border-blue-500 rounded-lg shadow-md hover:shadow-lg transition-shadow">
      ...
      <div>
        <div className="flex justify-between items-center mb-5">
          <h2 className="text-2xl font-bold text-gray-900">
            Results <span className="inline-flex items-center justify-center w-8 h-8 ml-2 text-sm font-bold text-blue-600 bg-blue-100 rounded-full">{fhirResponse.total}</span>
          </h2>
